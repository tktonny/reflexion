...
> Historical design reference: this document preserves the archived Python clinic platform and retains historical `/Users/macbookair/Documents/Cloud/REFLEXION` links for provenance. It is not an active build or deployment guide. Active Reflexion implementation work belongs under `/Users/chloetan/Documents/Reflexion`.
