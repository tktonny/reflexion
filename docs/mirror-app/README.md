...
> 审查日期：2026-07-22
> 范围：`mirror-app`、`caregiver-app`、`reflexion-server`、`_archived` 及相关产品、临床、合规文档
...
5. `mirror-app`、`reflexion-server` 和 `_archived` 是三套未统一的数据与服务路径。Python 平台已有更完整的身份、质量和纵向能力，但没有接入镜面端的 MongoDB 会话链路。
