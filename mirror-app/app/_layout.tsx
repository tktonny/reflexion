...
export default function RootLayout() {
  ...
  useEffect(() => {
    // A demo APK is deliberately self-contained. Do not send heartbeats or drain the production
    // outbox while the temporary local test surface is being used.
    if (DEMO_BUILD_ENABLED) return
  ...
  return (
    <>
      ...
      >
        ...
        <Stack.Screen name="paired-success" options={{ headerShown: false }} />
        ...
        <Stack.Screen name="family-message" options={{ headerShown: false }} />
