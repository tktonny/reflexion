...
export default function RealtimeTestScreen() {
  // Keep this historical/internal route available for non-demo development, but never let a
  // demo build enter the obsolete relay/cognitive-screening surface.
  if (DEMO_BUILD_ENABLED) return <Redirect href="/demo" />
  return <LegacyRealtimeTestScreen />
}

function LegacyRealtimeTestScreen() {
