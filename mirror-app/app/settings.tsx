    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.otaBanner}>
          <Ionicons name="checkmark-circle" size={20} color={c.sageDeep} />
          <Text style={styles.otaBannerText}>OTA test successful</Text>
        </View>
        ...
        <View style={styles.actions}>
          ...
          {networkSetupAvailable() ? <AdminAction icon="wifi-outline" label="Set up internet connection" onPress={() => router.push('/network-setup')} /> : null}
...
const styles = StyleSheet.create({
  ...
  otaBanner: { alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.72)', borderColor: c.goldDeep, borderRadius: 16, borderWidth: 1.5, flexDirection: 'row', gap: 10, paddingHorizontal: 18, paddingVertical: 14 },
  otaBannerText: { color: c.text, fontFamily: f.bodyMedium, fontSize: 16 },
