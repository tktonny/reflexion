...
import { clearPairingDiagnostics, getPairingDiagnostics } from '../lib/pairingDiagnostics'
...
export async function sendDeviceHeartbeat(report?: HardwareReport) {
  ...
  const pairingDiagnostics = await getPairingDiagnostics()
  try {
