...
const THRESHOLD = clampNumber(process.env.EXPO_PUBLIC_WAKE_WORD_THRESHOLD, 0.35, 0, 1)
const TRIGGER_HITS = Math.round(clampNumber(process.env.EXPO_PUBLIC_WAKE_WORD_HITS, 2, 1, 10))
