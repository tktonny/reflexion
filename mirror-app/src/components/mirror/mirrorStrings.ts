...
const EN: MirrorCopy = {
  ...
  ariaSpeaking: 'Aria is speaking…',
  repeat: 'Repeat',
  repeatQuestion: 'Repeat question',
  continue_btn: 'Continue',
  stop: 'Stop',
  soothingMessage: 'Take your time. I will wait until you finish.',
...
const ZH: MirrorCopy = {
  ...
  moodQuestion: '你今天感觉怎么样？',
  ariaSpeaking: 'Aria正在说话…',
  repeat: '重复',
  repeatQuestion: '重复问题',
  continue_btn: '继续',
  stop: '停止',
  soothingMessage: '别着急，我会等你讲完。',
