...
function statusCopy(state: V1FamilyMessage['state']) { return ({ scheduled: 'Scheduled', queued: 'Queued for the Mirror', delivered: 'Delivered to device', opened: 'Delivered to device · Viewed' })[state]; }
