...
export default function SessionDetailScreen() {
  ...
  return <ScreenLayout>
    ...
    <TertiaryButton label="Open full conversation" onPress={() => router.push(`/loved-one/${id}/sessions/${session.id}/conversation`)} />
...
const styles = StyleSheet.create({
  ...
  title: { color: colors.text.primary, flexShrink: 1, fontFamily: fontFamily.display, fontSize: fontSize.title, fontWeight: '500', marginTop: spacing.lg, minWidth: 0 }, subtitle: { color: colors.text.secondary, flexShrink: 1, fontSize: fontSize.body, lineHeight: 22, minWidth: 0 },
  statusCard: { alignItems: 'flex-start', backgroundColor: '#EEF7F0', borderColor: '#CFE4D0', borderRadius: radius.xl, borderWidth: 1, flexDirection: 'row', gap: spacing.md, minWidth: 0, padding: spacing.lg }, statusCopy: { flex: 1, flexShrink: 1, minWidth: 0 }, statusTitle: { color: colors.status.green, flexShrink: 1, fontSize: fontSize.bodyLarge, fontWeight: '700', minWidth: 0 }, statusDetail: { color: colors.text.secondary, flexShrink: 1, fontSize: fontSize.caption, lineHeight: 18, marginTop: 4, minWidth: 0 },
  card: { backgroundColor: colors.surface.card, borderColor: colors.border.default, borderRadius: radius.xl, borderWidth: 1, minWidth: 0, paddingHorizontal: spacing.xl }, section: { color: colors.text.primary, fontSize: fontSize.heading, fontWeight: '700', marginTop: spacing.md },
