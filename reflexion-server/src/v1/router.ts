...
import { familyMessagesRouter } from './routes/familyMessages.js'
...
// The current family-message contract must precede the legacy /opened aliases in devicesRouter.
v1Router.use(familyMessagesRouter)
