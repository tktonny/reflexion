...
const indexes: IndexSet[] = [
  ...
  [c.devices, [
    { key: { serialHash: 1 }, unique: true },
    { key: { localDeviceId: 1 }, unique: true, partialFilterExpression: { localDeviceId: { $type: 'string' } } },
    { key: { tenantId: 1, status: 1 } },
  ]],
  [c.pairings, [
    { key: { expiresAt: 1 }, expireAfterSeconds: 0 },
    { key: { codeHash: 1, state: 1 }, unique: true, partialFilterExpression: { state: 'pending' } },
    { key: { pairingTokenHash: 1 }, unique: true, partialFilterExpression: { pairingTokenHash: { $type: 'string' } } },
  ]],
  [c.assignments, [
  ...
  [c.familyMessages, [
    { key: { tenantId: 1, patientId: 1, createdAt: -1 } },
    { key: { tenantId: 1, patientId: 1, deliveryState: 1, createdAt: -1 } },
  ...
  [c.familyMessageReplies, [
    { key: { tenantId: 1, patientId: 1, originalMessageId: 1, createdAt: 1 } },
    { key: { tenantId: 1, patientId: 1, clientReplyId: 1 }, unique: true },
    { key: { tenantId: 1, originalMessageId: 1, state: 1, createdAt: 1 } },
  ]],
